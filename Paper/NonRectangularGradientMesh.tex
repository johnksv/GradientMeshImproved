...
\begin{figure}[t]
	...
	\caption{The red point indicates the location of were the user clicked. A new point is made at this location, as well as on all edges where the new column and row collide. The issue }
